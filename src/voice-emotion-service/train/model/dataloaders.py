...
def create_dataloaders(dataset: SpecDataset, config: ModelConfig):
    ...
    # 4. Create Datasets
    train_ds = SpecDataset(dataset.config, train_samples)
    val_ds = SpecDataset(dataset.config, val_samples)
    test_ds = SpecDataset(dataset.config, test_samples)
